...
public class AbsensiController {
    ...
    @PostMapping("/absensi")
    public String create(@RequestParam("montir") Long montir, @RequestParam("tanggal")@DateTimeFormat(pattern = "yyyy-MM-dd'T'HH:mm") LocalDateTime tanggal, @RequestParam("status") String status, @RequestParam("keterangan") String keterangan, RedirectAttributes redirectAttributes) {
